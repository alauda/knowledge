...
# Changing the Envoy Proxy Log Level at Runtime via the Admin Interface — for Gateway API and Service Mesh
## Issue
...
kubectl debug node/"$NODE" --image=docker.io/library/ubuntu:22.04 -it -- bash
```
