...
For downloading the offline installation package and uploading container images to your cluster registry, refer to the **[Offline Package Preparation](ArtifactPromotionRun_Approval_Notification_with_CorpWeChat_Install_kubeevent-enricher.md#offline-package-preparation)** section in the Installation Guide.
...
spec:
  ...
  sink:
    ...
    uri: "?broker=cloudevents-katanomi-dev"
---
apiVersion: v1
kind: ServiceAccount
metadata:
