...
> - **NetworkPolicy** — OVN ACL rules that depend on conntrack state will not match
> - **Service Load Balancing** — OVN LB rules for ClusterIP/NodePort services will be bypassed
>
