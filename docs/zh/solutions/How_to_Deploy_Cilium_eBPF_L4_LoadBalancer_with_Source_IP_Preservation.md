...
> **注意**：Cilium/eBPF 需要 Linux 内核 **5.10 或更高版本**（或等效版本，例如 RHEL 8.10 上的 4.18）。以下操作系统 **不支持**：
>
> - CentOS 7.x（内核版本 3.10.x）
> - RHEL 7.x（内核版本 3.10.x - 4.18.x）
> - Ubuntu 20.04（未启用 HWE 内核时内核版本为 5.4.x）
>
> 支持的操作系统：
>
> - Ubuntu 22.04（内核 5.15+）
> - RHEL 8.x（RHEL 8.10 上内核 4.18+，等效于 5.10）
> - openEuler 22.03（内核 5.10+）
